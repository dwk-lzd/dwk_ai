...
- 原子css
    ...
    - 设计工作流
        ...
        - 图片生成流程
            ...
            - 大模型  特征提取
            prompt
    - workflow_id  7533135201678884916
    - token pat_1LZgEHUHouEyG1EexLjnb1EnV1CGmRuHmeqHbqFV8KzPtigrnOS38uF9ormeitA5
    - coze 图片要先上传到coze中
...
- 语音输入发表文章
    ...
    - onMouseDown
    - BOM html5
    navigator.dediaDevices.getUserMedia({
        audio:true
    })
...
- 升级瀑布流
    - 骨架屏
    - 奇偶images 两列分配可能有时像天蚕脚一样，不好看，随机嘛
